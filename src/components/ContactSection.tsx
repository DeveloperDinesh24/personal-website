      ...
      <div className='max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20'>
        ...
        <form ref={form} onSubmit={sendEmail} className='space-y-6'>
          ...
          <button
            type='submit'
            disabled={isSending}
            className='w-full bg-indigo-600 hover:bg-indigo-500 text-white py-5 rounded-2xl font-black text-lg tracking-widest transition-all shadow-2xl shadow-indigo-600/30 cursor-pointer'
          >
            SEND MESSAGE
          </button>
        </form>
